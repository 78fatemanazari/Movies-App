...
**movies app** is a website that shows all popular movies. You can find your favorite movies by searching it's name in the search bar. You can see the rate of movies in the description below movie's picture. You can read the overview of each movies as well. In this project three free APIs has been used. 
- The main API (Movies)
- API for images
...
```sh
  ...
  git clone git@github.com:78fatemanazari/Movies-App.git
```
